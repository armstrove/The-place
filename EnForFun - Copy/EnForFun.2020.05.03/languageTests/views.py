...
class TopicListView(generic.ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for topic in topics_to_view:
            ...
            #aa=TopicProgress.objects.get(user=self.request.user, topic=topic)
        ...
        #topics_with_progress_info = [{'topic':topic,
        #                              'progress':TopicProgress.objects.get(user=self.request.user, topic=topic)}                
        #                            for topic in topics_to_view]
        pprint.pprint(topics_with_progress_info)
        #all_language_tests = all_language_tests.filter(level='b')
